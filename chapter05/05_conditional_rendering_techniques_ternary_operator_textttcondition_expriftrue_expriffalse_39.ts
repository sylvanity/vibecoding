...
// Subsection: Ternary Operator (\texttt{condition ? exprIfTrue : exprIfFalse
// Source: Building User Interfaces with React/Conditional Rendering Techniques.tex (line 64)
// Language: typescript
